...
class BayesNet:
    ...
    # Mothers = variáveis que ja sabemos Ex: Em A | B, mother = B
    ...
    def individualProb(self, variable, value):
        ...
        conjs = [[(variable,value)]+ c for c in self._gen_conjunctions([v for v in self.dependencies.keys() if v!= variable])]
        pprint.pprint(conjs)
